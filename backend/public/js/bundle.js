...
class UI{
    ...
    async renderBooks(){
        ...
        console.log(books);
        const booksCardContainer = document.getElementById('libros-cards');
        ...
        books.forEach(book => {
            ...
            div.innerHTML = `
                <div class="card m-2">
                    <div class="row">
                       <div class="col-md-4">
                            <img src="http://localhost:4000${book.imagePath}" class="img-fluid" /> 
                       </div> 
                       <div class="col-md-8">
                    ...
                    <div class="card-footer">${Object(timeago_js__WEBPACK_IMPORTED_MODULE_1__["format"])(book.created_at)}</div>
                </div>
            `;
    ...
    // renderMessage(mensaje, colorMensaje, segundos){
    //     const div = document.createElement('div');
    //     div.className = `alert alert-${colorMensaje} mensaje`;
    //     div.appendChild(document.createTextNode(mensaje));

    //     const contenedor = document.querySelector('.col-md-4');
    //     const bookForm = document.querySelector('#libro-form');

    //     contenedor.insertBefore(div, libro-form);
    //     setTimeout(() =>{
...
document.getElementById('libro-form')
  .addEventListener('submit', e => {
    ...
    //console.log(title, autor, id, image);
...
document.getElementById('libros-cards')
  .addEventListener('click', e =>{
    ...
    if(e.target.classList.contains('delete')){
     ...
     // ui.renderMessage('Nuevo eliminado', 'danger', 2000);
